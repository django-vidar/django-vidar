    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_directory_schema', models.CharField(blank=True, max_length=500, help_text=vidar.helpers.model_helpers.DIRECTORY_SCHEMA_HELP_TEXT)),
                ('video_filename_schema', models.CharField(blank=True, max_length=500, help_text=vidar.helpers.model_helpers.FILENAME_SCHEMA_HELP_TEXT)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('directory_schema', models.CharField(blank=True, max_length=500, help_text=vidar.helpers.model_helpers.DIRECTORY_SCHEMA_HELP_TEXT)),
                ('filename_schema', models.CharField(blank=True, max_length=500, help_text=vidar.helpers.model_helpers.FILENAME_SCHEMA_HELP_TEXT)),
            ],
            options={
