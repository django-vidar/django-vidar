...
class StatisticsHelpersTests(TestCase):
    ...
    def test_playlist_most_common_date_weekday_returns_zero_through_six_only(self):
        video = models.Video.objects.create(provider_object_id='tests', upload_date='2024-09-01')

        playlist = models.Playlist.objects.create(title='playlist 1')
        playlist.videos.add(video)

        self.assertEqual(0, statistics_helpers.most_common_date_weekday(queryset=playlist.videos))

        models.Video.objects.all().update(upload_date='2024-09-02')
        self.assertEqual(1, statistics_helpers.most_common_date_weekday(queryset=playlist.videos))

        models.Video.objects.all().update(upload_date='2024-09-03')
        self.assertEqual(2, statistics_helpers.most_common_date_weekday(queryset=playlist.videos))

        models.Video.objects.all().update(upload_date='2024-09-04')
        self.assertEqual(3, statistics_helpers.most_common_date_weekday(queryset=playlist.videos))

        models.Video.objects.all().update(upload_date='2024-09-05')
        self.assertEqual(4, statistics_helpers.most_common_date_weekday(queryset=playlist.videos))

        models.Video.objects.all().update(upload_date='2024-09-06')
        self.assertEqual(5, statistics_helpers.most_common_date_weekday(queryset=playlist.videos))

        models.Video.objects.all().update(upload_date='2024-09-07')
        self.assertEqual(6, statistics_helpers.most_common_date_weekday(queryset=playlist.videos))

        models.Video.objects.all().update(upload_date='2024-09-08')
        self.assertEqual(0, statistics_helpers.most_common_date_weekday(queryset=playlist.videos))

    def test_playlist_most_common_date_day_of_month(self):
        video = models.Video.objects.create(provider_object_id='tests', upload_date='2024-09-19')

        playlist = models.Playlist.objects.create(title='playlist 1')
        playlist.videos.add(video)

        self.assertEqual(19, statistics_helpers.most_common_date_day_of_month(queryset=playlist.videos))

    def test_playlist_most_common_date_day_of_month_with_multiple_videos_on_separate_days(self):
        video1 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-09-01')
        video2 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-09-19')
        video3 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-08-18')

        playlist = models.Playlist.objects.create(title='playlist 1')

        playlist.videos.add(video1, video2, video3)

        self.assertEqual(19, statistics_helpers.most_common_date_day_of_month(queryset=playlist.videos))

    def test_playlist_most_common_date_day_of_month_with_multiple_videos_on_same_days(self):
        video1 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-09-01')
        video2 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-09-19')
        video3 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-08-18')
        video4 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-08-19')

        playlist = models.Playlist.objects.create(title='playlist 1')
        playlist.videos.add(video1, video2, video3, video4)

        self.assertEqual(19, statistics_helpers.most_common_date_day_of_month(queryset=playlist.videos))

    def test_playlist_most_common_date_day_of_month_with_31st_as_most_common_returns_30(self):
        video1 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-09-01')
        video2 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-08-31')
        video3 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-08-18')
        video4 = models.Video.objects.create(provider_object_id='tests', upload_date='2024-08-31')

        playlist = models.Playlist.objects.create(title='playlist 1')
        playlist.videos.add(video1, video2, video3, video4)

        self.assertEqual(30, statistics_helpers.most_common_date_day_of_month(queryset=playlist.videos))
